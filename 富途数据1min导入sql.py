...
engine = create_engine('mysql+pymysql://root:mylove520@localhost/stocks_1m?charset=utf8')
df.to_sql(name='HK.00700',con=engine,if_exists='append',index=True)
